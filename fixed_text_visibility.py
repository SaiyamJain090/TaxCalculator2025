...
# Improved CSS for better contrast and overriding Streamlit's default styles
st.markdown(
    '''
    <style>
    /* Background color */
    ...
    /* Forcefully override faded Streamlit descriptions */
    div[data-testid="stMarkdownContainer"] p {
        color: #003366 !important;  /* Dark Blue */
        font-weight: bold !important;
    }
    /* Improve input field labels and radio buttons */
    label {
        font-weight: bold !important;
        color: #003366 !important;  /* Dark Blue */
    }
